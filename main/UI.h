...
namespace UI {
    bool CreateText(TextId id, const wchar_t* text, TextFormatId formatId, TextAnchor anchor, float offsetX, float offsetY, float width, float height);
    TextDrawRequest* FindText(TextId id);
    bool SetText(TextId id, const wchar_t* text);
